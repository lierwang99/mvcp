...
//		}
		if (!"/mvcp/index.jsp".equals(currentURI)) {// 判断当前页是否是重定向以后的登录页面页面，如果是就不做session的判断，防止出现死循环
			System.out.println(session == null);
			if(session != null) {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		System.out.println("visit的filter初始化了");
		System.out.println("拦截器的名字"+filterConfig.getFilterName());
	}
